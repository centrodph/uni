...
int main()
{
    //Desarrollar un algoritmo y codificarlo en C que permita:
    //Dados dos números enteros A y B, calcule su potencia (A^B) en forma recursiva
    //Desarrollar un programa que ingresando un número calcule cuáles de todos los números anteriores son primos
