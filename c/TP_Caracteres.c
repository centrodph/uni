...
int main(){
    ...
    // Mostrar el texto con tres blancos de separación entre cada palabra
    // Contar cuantas palabras comienzan en 'a' y terminan en 's'
    // Reemplazar la primera letra de cada palabra por la primera letra ingresada en la frase
